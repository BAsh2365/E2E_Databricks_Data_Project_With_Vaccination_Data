...
# MAGIC %pip install --force-reinstall databricks-automl-runtime==0.2.20.14
# MAGIC %pip install mlflow==2.20.0
...
# MAGIC - To reproduce these results, attach this notebook to Serverless compute, and rerun it.
# MAGIC - Compare trials in the [MLflow experiment](#mlflow/experiments/676033875561864).
...
input_data_path = mlflow.artifacts.download_artifacts(run_id="a0cfcac74087431e9590f35d341ef861", artifact_path="data", dst_path=input_temp_dir)
...
# MAGIC %md
# MAGIC ## Aggregate data by `time_col` and `split_col`
# MAGIC Group the data by `time_col` and `split_col`, and take average if there are multiple `target_col` values in the same group.
...
# MAGIC - All the runs are logged under [this MLflow experiment](#mlflow/experiments/676033875561864)
...
with mlflow.start_run(experiment_id="676033875561864") as mlflow_run:
